            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg dark:bg-gray-800">
                <form method="POST" action="{{ route('tasks.update', $task->id) }}" class="space-y-4">
                    ...
                    <div class="flex justify-end gap-2">
                        <a href="{{ route('tasks.show', $task->id) }}" class="rounded-md border border-gray-300 px-4 py-2 text-sm text-gray-700 dark:border-gray-600 dark:text-gray-200">Cancel</a>
